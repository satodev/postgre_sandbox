...
quick reminder here that this db won't be able to be used outside of this local env
we shall adapt configuration files in order to avoid errors of communication and other stuff


# Exercice 

here are the instructions of the exercice in SQL that i have to make 
